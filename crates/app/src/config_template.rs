...
const INTERPRETER: &[Row] = &[
    ...
    d(
        ...
        &[
            ...
            "  \"auto\" — report a 14px-tall cell whatever your font is, so a game's",
            "           artwork scales WITH your text instead of against it",
            "  1      — report your terminal's real cell size (the author's literal",
            "           pixels: a fixed-size strip however large your font)",
